  ...
  return (
    <div className="min-h-[calc(100vh-57px)] bg-white">
      ...
      <section className="flex flex-col items-center justify-center px-6 py-20 text-center">
        <p className="mb-4 text-[11px] font-medium tracking-widest" style={{ color: '#C0C0C0', letterSpacing: '0.12em' }}>
          Your finds, their opinions
        </p>
        <h1 className="mb-5 max-w-sm text-[32px] font-medium leading-tight text-shoppi-ink">
          Shopping is better with friends
        </h1>
        <p className="mb-10 max-w-sm text-[14px] leading-relaxed" style={{ color: '#888' }}>
      ...
      <section className="px-6 py-10">
        <div className="grid grid-cols-3 gap-[6px]" style={{ gridTemplateRows: 'repeat(3, auto)' }}>
          ...
          >
            <p className="text-[22px] font-medium text-white leading-tight">The Edit</p>
            <p className="text-[10px] mt-1" style={{ color: '#888' }}>Curated by your circle</p>
          </div>
          ...
          >
            <p className="text-[15px] font-medium text-shoppi-ink leading-snug">
      ...
      <section className="px-6 pb-10">
        <p className="mb-5 text-[11px] font-medium tracking-widest" style={{ color: '#C0C0C0', letterSpacing: '0.12em' }}>
          How it works
        </p>
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            <div key={n} className="rounded-[6px] border p-4" style={{ borderColor: '#C0C0C0' }}>
              <p className="text-[20px] font-medium mb-2" style={{ color: '#E8651A' }}>{n}</p>
              <p className="text-[13px] font-medium text-shoppi-ink mb-1">{title}</p>
      ...
      <section className="border-t px-6 py-16 text-center" style={{ borderColor: '#C0C0C0' }}>
